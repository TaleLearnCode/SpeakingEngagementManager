...
namespace TaleLearnCode.SpeakingEngagementManager.Data.EntityFramework.Cosmos
{
	...
	internal static partial class CreateModel
	{
		...
		/// <summary>
		/// Creates the EF model for the <see cref="Cosmos.Tag"/>
		/// </summary>
		...
		internal static void Tag(ModelBuilder modelBuilder)
		{
			modelBuilder.Entity<Tag>(
				entity =>
				{
					...
					entity.Property(p => p.Id).ToJsonProperty(Domain.PropertyNames.Tag.Id);
					entity.Property(p => p.OwnerEmailAddress).ToJsonProperty(Domain.PropertyNames.PartitionKey.CosmosPartitionKey);
					entity.Property(p => p.Name).ToJsonProperty(Domain.PropertyNames.Tag.Name);
					entity.Property(p => p.PresentationTags).ToJsonProperty(Domain.PropertyNames.Tag.PresentationTags);
				});
